...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'site_Voyage_Lancelot_c931ae752bd9fafd2100_20230104132607_archive.zip';
        const ARCHIVE_SIZE       = '75187814';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'c931ae7-04132607';
        const SECONDARY_PACKAGE_HASH = 'eb281c9-04132607';
        const VERSION            = '1.5.1';
